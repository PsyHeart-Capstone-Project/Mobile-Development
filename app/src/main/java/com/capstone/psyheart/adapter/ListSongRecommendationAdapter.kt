...
class ListSongRecommendationAdapter(private val listStories: List<Recommendation>) : RecyclerView.Adapter<ListSongRecommendationAdapter.ListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val song: Recommendation = listStories[position]
